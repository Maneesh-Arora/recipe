package com.pluralsight.recipe.bootstrap;

import com.pluralsight.recipe.models.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryJPARepository categoryRepository, UnitOfMeasureJPARepository unitOfMeasureRepository, RecipeJPARepository recipeJPARepository) {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        recipeJPARepository.saveAll(getRecipes());
    }
